...
//
// WHY << 1: Left shift = multiply by 2 = "move all existing bits one position left
// to make room for the next bit in the ones place."
//
// WHY | val: OR sets the lowest bit to the new digit. Since shifting always fills
// the lowest bit with 0, OR safely places our new bit there.
//
